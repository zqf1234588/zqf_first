"""
Dungeon
The chicken is a player, the bird's nest is the door, the banana is movementincrease,
and the trash can is the key
"""
__author__ = "{{Qifeng Zhong}})"
__email__ = "scyqz5@nottingham.edu.cn"
__date__ = "30/10/2020"
...
class AdvancedDungeonMap(AbstractGrid):
    ...
    def __init__(self, master, size, width, **kwargs):
        ...
        self.img_key = self.loadimg("images/key.gif")
